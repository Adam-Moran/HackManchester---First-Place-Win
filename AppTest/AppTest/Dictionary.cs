...
namespace AppTest
{
    class Dictionary
    {
        public Dictionary<string, object> productDictionary = new Dictionary<string, object>
        {
            ...
            { "3329770056923", new {name = "Froobe", image = Resource.Drawable.froob}},
            { "5030765032904", new {name = "Caramel Chocolate", image = Resource.Drawable.caramel}},
            { "7613033591877", new {name = "Blue Ribbon", image = Resource.Drawable.ribbo}},
            { "Key1", new {name = "haribo", image = Resource.Drawable.haribobears}},
            { "7622210723512", new {name = "Chomp", image = Resource.Drawable.chomp}},
            { "8008440222008", new {name = "Peroni", image = Resource.Drawable.peroni}},
            { "5020379129541", new {name = "Fruit Shortcake", image = Resource.Drawable.shortcake}},
