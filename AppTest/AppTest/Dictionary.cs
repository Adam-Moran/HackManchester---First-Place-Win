...
namespace AppTest
{
    ...
    public class Dictionary
    {
        public Dictionary<string, object> productDictionary = new Dictionary<string, object>
        {
            ...
            { "5054268158985", new DictionaryItem("Chocolate Cookies", Resource.Drawable.Cookies)},
            ...
            { "5054267000605", new DictionaryItem("Lucozade", Resource.Drawable.lucozade)},
            { "5054267003286", new DictionaryItem("Lucozade", Resource.Drawable.lucozade)},
            ...
            { "51000009", new DictionaryItem("Crisps", Resource.Drawable.crisps2)},
            { "51000005", new DictionaryItem("Crisps", Resource.Drawable.crisps1)},
